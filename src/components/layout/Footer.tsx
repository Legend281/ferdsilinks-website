...
export function Footer() {
  return (
    <>
      {/* Floating WhatsApp */}
<Link className="fixed bottom-8 right-8 w-16 h-16 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-all z-[100] group" href="https://wa.me/yournumber" target="_blank">
...
<span className="absolute right-full mr-4 bg-primary text-white text-xs px-3 py-2 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">Chat with us</span>
      ...
      <footer className="bg-[#002147] dark:bg-[#000a1e] w-full pt-20 pb-10 text-[#ffdcc3] font-body text-sm leading-relaxed">
...
<li><Link className="hover:text-[#ffdcc3] transition-colors hover:translate-x-1 inline-block transition-transform duration-200" href="#">Data Science Lab</Link></li>
<li><Link className="hover:text-[#ffdcc3] transition-colors hover:translate-x-1 inline-block transition-transform duration-200" href="#">AI Integration</Link></li>
<li><Link className="hover:text-[#ffdcc3] transition-colors hover:translate-x-1 inline-block transition-transform duration-200" href="#">Cloud Systems</Link></li>
<li><Link className="hover:text-[#ffdcc3] transition-colors hover:translate-x-1 inline-block transition-transform duration-200" href="#">Software Architecture</Link></li>
</ul>
</div>
<div>
<h4 className="font-headline font-bold text-white mb-6 uppercase tracking-widest text-xs">Resources</h4>
<ul className="space-y-4 text-slate-400">
<li><Link className="hover:text-[#ffdcc3] transition-colors hover:translate-x-1 inline-block transition-transform duration-200" href="#">Training Hub</Link></li>
<li><Link className="hover:text-[#ffdcc3] transition-colors hover:translate-x-1 inline-block transition-transform duration-200" href="#">Silicon Mountain Blog</Link></li>
<li><Link className="hover:text-[#ffdcc3] transition-colors hover:translate-x-1 inline-block transition-transform duration-200" href="#">Podcast Episodes</Link></li>
<li><Link className="hover:text-[#ffdcc3] transition-colors hover:translate-x-1 inline-block transition-transform duration-200" href="#">Case Studies</Link></li>
</ul>
</div>
<div>
