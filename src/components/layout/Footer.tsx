...
<a href="https://www.youtube.com/@ferdsilinks" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-on-tertiary-container transition-colors cursor-pointer text-white hover:text-[#ffdcc3]">
