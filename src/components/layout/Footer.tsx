  ...
  return (
    <>
      ...
      <Link className="fixed bottom-8 right-8 w-16 h-16 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-all z-[100] group" href="https://wa.me/yournumber" target="_blank">
        ...
        <span className="absolute right-full mr-4 bg-primary text-white text-xs px-3 py-2 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">{t.footer.chat}</span>
      </Link>
...
<div>
<h4 className="font-headline font-bold text-white mb-6 uppercase tracking-widest text-xs">{t.footer.servicesTitle}</h4>
...
<div>
<h4 className="font-headline font-bold text-white mb-6 uppercase tracking-widest text-xs">{t.footer.companyTitle}</h4>
<ul className="space-y-4 text-slate-400">
...
<div>
<h4 className="font-headline font-bold text-white mb-6 uppercase tracking-widest text-xs">{t.footer.officeTitle}</h4>
<p className="text-slate-400 mb-4">{t.footer.officeAddressLine1}<br/>{t.footer.officeAddressLine2}<br/>{t.footer.officeAddressLine3}</p>
<Link className="text-on-tertiary-container font-bold underline underline-offset-4" href="#">{t.footer.getDirections}</Link>
</div>
</div>
...
<Link className="hover:text-white" href="#">{t.footer.privacy}</Link>
<Link className="hover:text-white" href="#">{t.footer.terms}</Link>
</div>
</div>
</footer>
    </>
