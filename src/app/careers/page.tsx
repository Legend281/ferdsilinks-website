...
export default function CareersPage() {
  ...
  const filters = ["All", "Engineering", "Data", "Training"];
              ...
              <div className="max-w-5xl mx-auto px-8">
                      ...
                      <div className="flex gap-2 p-1.5 bg-surface-container-high rounded-lg overflow-x-auto [scrollbar-width:none]">
                          {filters.map(filter => (
                              <button 
                                ...
                                className={`px-6 py-2 font-bold rounded shadow-sm text-sm transition-all ${
                                    activeFilter === filter 
                  ...
                  <div className="space-y-4">
                      {filteredJobs.length > 0 ? filteredJobs.map((job, index) => (
                          <div key={index} className="group bg-surface-container-low hover:bg-surface-container-lowest p-8 rounded-xl flex flex-col md:flex-row justify-between items-start md:items-center transition-all cursor-pointer border border-transparent hover:border-outline-variant/30 hover:shadow-xl">
                              <div>
                              ...
                              <span className="material-symbols-outlined text-3xl text-outline-variant group-hover:text-on-tertiary-container group-hover:translate-x-2 transition-transform duration-300 mt-6 md:mt-0">arrow_forward</span>
                          </div>
                      )) : (
